...
**Broad / ambiguous entity query:**
Input: show me everything for user alex@acme.com
MCP: `{ "query": "everything for user alex@acme.com", "limit": 5 }`
Behavior: Pass through as-is. If the MCP asks which entity type to return (sessions, traces, events), present those options to the user.
